...
public class MainActivity extends AppCompatActivity {
    //----------------------------------------------------------------------------------------------
    // Pantalla para introducir tu nombre de usuario y pasar a buscar un rival para competir
    //----------------------------------------------------------------------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(nombre_rival != null){
            new BorraMensajesBaseDeDatos().executeOnExecutor(
                    AsyncTask.THREAD_POOL_EXECUTOR, MainActivity.nombre, MainActivity.nombre_rival);
        }
        ...
        if(RegistraUsuario.registro_finalizado){
            ...
            nomb.setText(MainActivity.nombre);

            EditText contra = (EditText) findViewById(R.id.pass);
            contra.setText(MainActivity.password);
    ...
    public void onConectar(View v){
        ...
        MainActivity.password = pass.getText().toString();
